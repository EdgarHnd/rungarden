...
const challenges: Challenge[] = [
  ...
  // Weather & Environment
  { id: '4', emoji: '🔥', name: 'Hot Hero', description: 'Run above 30°C', reward: 'Sunhat' },
  ...
  // Distance & Cumulative
  { id: '14', emoji: '🧦', name: '20km Club', description: '20 km cumulative', reward: 'Neon socks' },
  { id: '15', emoji: '🩳', name: '50km Club', description: '50 km cumulative', reward: 'Camouflage shorts' },
  { id: '16', emoji: '🪶', name: '200km Club', description: '200 km cumulative', reward: 'Wings accessory' },
  { id: '17', emoji: '🦘', name: '500km Club', description: '500 km cumulative', reward: 'Koala superhero costume' },

  // Intensity & Speed
  { id: '18', emoji: '⏱️', name: 'PB Breaker', description: 'Beat your personal best', reward: 'Stopwatch necklace' },
  { id: '19', emoji: '⚡', name: 'Speed Demon', description: '1 km under 6 minutes', reward: 'Flash lightning shoes' },
